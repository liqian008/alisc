...
public class KhCountryEntityCriteria extends KhCriteriaBase implements Serializable {
    /**
     * 查询或条件
     */
     ...
     * 构造查询条件,kh_country
     */
    public KhCountryEntityCriteria() {
        oredCriteria = new ArrayList<>();
    }

    /**
     * 获取当前的查询条件实例,kh_country
     */
