  ...
  */
  ...
  Class.prototype.render = function(){
    ...
    lay.each(new Array(2), function(i){
      ...
      if(options.range && options.title){
        var divHeaderTitle = lay.elem('div',{
          style: 'padding:10px 0 5px;text-align:center;font-weight:bold;color:#666;'
        });
        divHeaderTitle.innerHTML = options.title && options.title[i] || '';
  ...
  Class.prototype.calendar = function(value){
    ...
    // 设置周一为第一天
    startWeek = (thisDate.getDay() + (7 - 1)) % 7;
