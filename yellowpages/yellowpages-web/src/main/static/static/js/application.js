...
================================================== */
	...
	oTable = $('.datatable table').dataTable({
		...
		"oLanguage": {
			"sSearch": "<span>筛选条件:</span> _INPUT_",
			"sLengthMenu": "<span>显示条数:</span> _MENU_",
	...
	$('.dataTables_filter input[type=text]').attr('placeholder','请点击选择日期');
...
================================================== */
	...
	$('#reportrange').daterangepicker(
	{
		...
		'尾页 7 Days': [moment().subtract('days', 6), moment()],
		'This Month': [moment().startOf('month'), moment().endOf('month')],
		'尾页 Month': [moment().subtract('month', 1).startOf('month'), moment().subtract('month', 1).endOf('month')]
	},
	opens: 'left',
	buttonClasses: ['btn'],
